...
INTERNAL_CUSTOM_BOOTIMAGE_ARGS := --base $(BOARD_KERNEL_BASE) --pagesize $(BOARD_KERNEL_PAGESIZE) --kernel $(INSTALLED_KERNEL_TARGET) --ramdisk $(BUILT_RAMDISK_TARGET) --cmdline "$(BOARD_KERNEL_CMDLINE) buildvariant=$(TARGET_BUILD_VARIANT)"
